 ...
 * `bem-xjst` (https://github.com/bem/bem-xjst). Поддерживает как js-совместимый, так и первоначальный синтаксис.
 * Транслирование из первоначального в js-синтаксис осуществляется с помощью библиотеки
