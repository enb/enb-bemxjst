...
Модуль `bem-xjst` обновлен до версии `7.7.7`. О всех изменениях `bem-xjst` читайте в примечаниях к релизам:

* [v7.7.7](https://github.com/bem/bem-xjst/releases/tag/v7.7.7)
...
Модуль `bem-xjst` обновлен до версии `7.7.6`. Размер бандла bem-xjst уменьшен на
1КБ. Из опциональных закрывающих тегов исключены UL и OL. Теперь они всегда
будут закрываться при использовании соответствующей опции в bem-xjst.

О всех изменениях `bem-xjst` читайте в примечаниях к релизам:

* [v7.7.6](https://github.com/bem/bem-xjst/releases/tag/v7.7.6)
...
Модуль `bem-xjst` обновлен до версии `7.7.4`. Исправлена утечка памяти в bem-xjst.

О всех изменениях `bem-xjst` читайте в примечаниях к релизам:

* [v7.7.4](https://github.com/bem/bem-xjst/releases/tag/v7.7.4)
...
Модуль `bem-xjst` обновлен до версии `7.7.3`.

О всех изменениях `bem-xjst` читайте в примечаниях к релизам:

* [v7.7.3](https://github.com/bem/bem-xjst/releases/tag/v7.7.3)
...
Модуль `bem-xjst` обновлен до версии `7.7.2`.

О всех изменениях `bem-xjst` читайте в примечаниях к релизам:

* [v7.7.2](https://github.com/bem/bem-xjst/releases/tag/v7.7.2)
...
Модуль `bem-xjst` обновлен до версии `7.6.4`. Обращаем ваше внимание, что релиз
7.6.3 откатывает изменения полученные в 7.6.2, поэтому они оба пропущены.

О всех изменениях `bem-xjst` читайте в примечаниях к релизам:

* [v7.6.4](https://github.com/bem/bem-xjst/releases/tag/v7.6.4)
...
Модуль `bem-xjst` обновлен до версии `7.6.1`.
...
Модуль `bem-xjst` обновлен до версии `7.6.0`.

О всех изменениях `bem-xjst` читайте в примечаниях к релизам:

* [v7.6.0](https://github.com/bem/bem-xjst/releases/tag/v7.6.0)
...
Модуль `bem-xjst` обновлен до версии `7.5.0`.

О всех изменениях `bem-xjst` читайте в примечаниях к релизам:

* [v7.5.0](https://github.com/bem/bem-xjst/releases/tag/v7.5.0)
...
Модуль `bem-xjst` обновлен до версии `7.4.1`.

О всех изменениях `bem-xjst` читайте в примечаниях к релизам:

* [v7.4.1](https://github.com/bem/bem-xjst/releases/tag/v7.4.1)
...
Модуль `bem-xjst` обновлен до версии `7.4.0`.

О всех изменениях `bem-xjst` читайте в примечаниях к релизам:

* [v7.4.0](https://github.com/bem/bem-xjst/releases/tag/v7.4.0)
...
* Исправлена работа в среде исполнения `V8` (например, `Perl:V8`): нет объекта `global` ([#226]).
