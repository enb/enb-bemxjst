...
Обновлен bem-xjst до v6.7.2. Обо всех изменениях `bem-xjst` читайте в примечаниях к релизам:

* [v6.7.2](https://github.com/bem/bem-xjst/releases/tag/v6.7.2)

6.7.2
-----

Обновлен bem-xjst с v6.7.0 до v6.7.1. В нем исправлена утечка памяти в bem-xjst.
...
Обновлен bem-xjst с v6.6.0 до v6.7.0. В нем появилась новая опция `production`.

6.6.0
-----

Обновлен bem-xjst с v6.5.5 до v6.6.0. В нем появилась новая опция `runtimeLint`.
