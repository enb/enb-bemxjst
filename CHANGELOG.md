...
* Модуль `bem-xjst@4.4.1` обновлен до версии `4.4.1`.
...
Модуль `bem-xjst@4.3.4` обновлен до версии `4.4.0`.

О всех изменениях `bem-xjst` читайте в [примечании к релизу](https://github.com/bem/bem-xjst/releases/tag/v4.4.0).

### Опции

* Для технологии `bemhtml` добавлена опция [engineOptions](api.ru.md#engineoptions) (портировано из [v6.3.0](https://github.com/enb/enb-bemxjst/releases/tag/v6.3.0)).
